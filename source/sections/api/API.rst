...
For the fastest way to get started using CPSign API, please refer to our `GitHub <https://github.com/arosbio/cpsign-examples>`_ page with programming examples that get you up and running in no time!
